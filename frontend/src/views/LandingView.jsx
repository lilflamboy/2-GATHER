...
function LandingView({addToast}){
  ...
  return(
    <div className="min-h-screen bg-screen relative overflow-hidden px-6 py-10 sm:px-8 sm:py-12">
      ...
      <div className="absolute right-[-8rem] top-24 h-[26rem] w-[26rem] rounded-full bg-white/5 blur-3xl pointer-events-none"/>
      <div className="absolute left-[-10rem] bottom-[-8rem] h-[24rem] w-[24rem] rounded-full bg-amber-400/10 blur-3xl pointer-events-none"/>
      <div className="absolute inset-x-[18%] top-[18%] h-56 rounded-full bg-amber-100/5 blur-3xl pointer-events-none"/>
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-lg items-center justify-center">
        <div className="relative flex w-full flex-col gap-8">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="flex h-20 w-20 items-center justify-center rounded-[1.75rem] border border-amber-400/25 bg-gradient-to-br from-amber-500/20 via-amber-400/10 to-zinc-900/55 shadow-[0_24px_80px_rgba(245,158,11,0.16)]">
